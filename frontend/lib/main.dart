...
import 'screens/profiles/criar_perfil_screen.dart';
...
import 'screens/profile/minha_lista_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AppRoutes.criarPerfil:    (_) => const CriarPerfilScreen(),
        AppRoutes.home:           (_) => const MainNavigationScreen(),
        AppRoutes.minhaLista:     (_) => const MinhaListaScreen(),
