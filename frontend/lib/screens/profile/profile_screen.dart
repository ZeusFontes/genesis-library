...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final menuItems = [
      (Icons.bookmark_outline, 'Minha Lista', AppRoutes.historico),
      ...
      (Icons.help_outline, 'Ajuda', null),
      (Icons.info_outline, 'Sobre o GÊNESIS', null),
    ];
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        imageUrl:
                            'https://api.dicebear.com/10.x/thumbs/png?seed=Admin',
                        width: 90,
                        height: 90,
